...
public class Skidmarks : MonoBehaviour {
	...
	#region Singleton
	private static Skidmarks _Instance;
	public static Skidmarks Instance
	{
		get
		{
			if (_Instance == null)
				_Instance = FindObjectOfType<Skidmarks>();
			return _Instance;
		}
	}
	#endregion
	...
	public int MAX_MARKS = 2048; // Max number of marks total for everyone together
	public float MARK_WIDTH = 0.35f; // Width of the skidmarks. Should match the width of the wheels
	public float GROUND_OFFSET = 0.02f;  // Distance above surface in metres
	public float MIN_DISTANCE = 0.25f; // Distance between skid texture sections in metres. Bigger = better performance, less smooth
	public float MIN_SQR_DISTANCE = 0.5f;
	public float MAX_OPACITY = 1.0f; // Max skidmark opacity
