...
public class VehicleCameraController : MonoBehaviour
    ...
    public bool cinematicCrashMode = false;
	...
	void DoMouseOrbit ()
		...
		if (target == null) return;
            ...
            {
                m_orbitX += 0.5f * orbitSettings.horizontalSpeed;
                m_orbitY = smoothFollowSettings.height * 5f;
                //orbitSettings.distance -= Input.GetAxis("Mouse ScrollWheel") * orbitSettings.distanceSpeed;

                orbitSettings.distance = 12f;
